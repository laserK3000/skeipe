...
!function (e, t) {
  ...
  return function (e) {
    ...
    function s() {
      var e = arguments[0], t = arguments[1], s = Array.prototype.slice.call(arguments, 2);
      if (!(n[t] < e.level)) for (var o = !(e.options.disableCallerInfo || i.disableCallerInfo) && function () {
    ...
    function l(e, t, n, r) {
      ...
      if (void 0 === (s = e._events) ? (s = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== s.newListener && (e.emit('newListener', t, n.listener ? n.listener : n), s = e._events), o = s[t]), void 0 === o) o = s[t] = n, ++e._eventsCount; else if ('function' == typeof o ? o = s[t] = r ? [n, o] : [o, n] : r ? o.unshift(n) : o.push(n), (i = u(e)) > 0 && o.length > i && !o.warned) {
        o.warned = !0;
    ...
    e.exports = function (e) {
      ...
      return t = setInterval((function () {
        ...
        if (e === h) {
          ...
          o = []
        } else l.send({ method: '__ready__', params: e })
      })), l
    }
  }, function (e) {
    e.exports = {
      'google-auth': { matchPatterns: { url: 'accounts.google.com' }, target: 'electron' },
      'dropbox-auth': { matchPatterns: { url: 'dropbox.com/oauth2/authorize' }, target: 'electron' }
    }
  }, function (e, t, n) {
    ...
    n.r(t);
    var r = n(2), i = n.n(r);
    const s = 'org.jitsi.meet:', o = '(//[^/?#]+)', a = '([^?#]*)', c = '^([a-z][a-z0-9\\.\\+-]*:)';

    function u(e) {
      const t = new RegExp(`${c}+`, 'gi'), n = t.exec(e);
      if (n) {
    ...
    const y = { window: window.opener || window.parent }, b = 'message';
    ...
    class _ {
      constructor({ postisOptions: e } = {}) {
        this.postis = m()(function (e) {
          ...
          return e
        }({}, y, e)), this._receiveCallback = () => {
        }, this.postis.listen(b, e => this._receiveCallback(e))
      }
    ...
    const w = 'event', L = 'request', O = 'response';
    ...
    const k = ['css/all.css', 'libs/alwaysontop.min.js'], P = {
    ...
    function D(e, t = {}) {
      return p(function (e) {
        ...
        return e
      }({}, t, { url: `${t.noSSL ? 'http' : 'https'}://${e}/#jitsi_meet_external_api_id=${M}` }))
    }
    ...
    class $ extends i.a {
      constructor(e, ...t) {
        super();
        const { roomName: n = '', width: r = '100%', height: i = '100%', parentNode: s = document.body, configOverwrite: o = {}, interfaceConfigOverwrite: a = {}, noSSL: c = !1, jwt: u, onload: l, invitees: h, devices: d, userInfo: p } = function (e) {
          if (!e.length) return {};
          switch (typeof e[0]) {
            case'string':
            case void 0: {
        ...
        this._parentNode = s, this._url = D(e, {
          configOverwrite: o,
          ...
          backend: new _({
            postisOptions: {
              scope: `jitsi_meet_external_api_${M}`,
              window: this._frame.contentWindow
            }
          })
        }), Array.isArray(h) && h.length > 0 && this.invite(h), this._isLargeVideoVisible = !0, this._numberOfParticipants = 0, this._participants = {}, this._myUserID = void 0, this._onStageParticipant = void 0, this._setupListeners(), M++
      }

      _createIFrame(e, t, n) {
        const r = `jitsiConferenceFrame${M}`;
      ...
      _setupListeners() {
        this._transport.on('event', e => {
          let { name: t } = e, n = I(e, ['name']);
          const r = n.id;
          switch (t) {
            case'video-conference-joined':
              this._myUserID = r, this._participants[r] = { avatarURL: n.avatarURL };
            case'participant-joined':
              this._participants[r] = this._participants[r] || {}, this._participants[r].displayName = n.displayName, this._participants[r].formattedDisplayName = n.formattedDisplayName, A(this, 1);
              break;
            case'participant-left':
              A(this, -1), delete this._participants[r];
              break;
            ...
            case'video-conference-left':
              A(this, -1), delete this._participants[this._myUserID]
          }
          const i = N[t];
